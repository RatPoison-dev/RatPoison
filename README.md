...
directory, and will in a directory called **RatPlague 1.0.11**.

From within the **RatPlague 1.0.11** directory, you can start the cheat by running
the _"Start RatPlague 1.0.11"_ script.
