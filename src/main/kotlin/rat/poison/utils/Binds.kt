...
var headWalkToggleKey = ObservableBoolean({ keyPressed(1)})
...
fun constructVars() {
    ...
    headWalkToggleKey = ObservableBoolean({ curSettings["HEAD_WALK_KEY_TYPE"] == "SwitchKey" && keyPressed(curSettings["HEAD_WALK_KEY"].toInt()) })
