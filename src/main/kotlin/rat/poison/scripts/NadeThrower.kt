...
private var eyeAng = Vector(0F, 0F, 0F)

private var closestAngle = Vector(90F, 90F, 90F)
private var closestDistance = 100F
private var clfSpot = listOf<Any>()

fun autoThrowNade(fSpot: List<Any>, recoveredAngle: Vector) {
    eyeAng = me.eyeAngle()
    ...
    if (calcRes < 0.1) {
        ...
        closestAngle = Vector(90F, 90F, 90F)
...
fun nadeThrower() = every(10, inGameCheck = true) {
    ...
    if (nadeToCheck != "") {
        ...
        if (closestAngle != Vector(90F, 90F, 90F)) {
