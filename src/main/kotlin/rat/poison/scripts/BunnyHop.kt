...
fun bunnyHop() = every(1, continuous = true, inGameCheck = true) {
    if (!curSettings.bool["ENABLE_BUNNY_HOP"] || me < 0  || meDead || !me.onGround() || cursorEnable || !keyPressed(curSettings.int["ENABLE_BUNNY_HOP_KEY"]) || (randInt(0, 100) > curSettings.int["BHOP_HITCHANCE"])) return@every
    updateCursorEnable()
