...
internal fun boxEsp() = App {
	...
	forEntities(ccsPlayer) { //Only enemies atm
		...
		if (entity == me || entity.dead() || entity.dormant() || (!curSettings["BOX_SHOW_ENEMIES"]!!.strToBool() && me.team() != entity.team()) || (!curSettings["BOX_SHOW_TEAM"]!!.strToBool() && me.team() == entity.team()) ) return@forEntities false
