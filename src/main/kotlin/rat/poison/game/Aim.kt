...
fun realCalcAngle(player: Player, dst: Vector): Angle {
	...
	var aX = toDegrees(atan2(-delta.z, sqrt(delta.x*delta.x + delta.y*delta.y)).toDouble())// - myPunch.x * 2.0
	var aY = toDegrees(atan2(delta.y, delta.x).toDouble())// - myPunch.y * 2.0
