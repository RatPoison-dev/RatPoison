...
class AimShotgunTab : Tab(true, false) { //Aim.kts tab
    ...
    val aimFovLabel = VisLabel("Aim Fov: " + SHOTGUN_AIM_FOV.toString() + when(SHOTGUN_AIM_FOV.toString().length) {3->"  " 2->"    " else ->"      "}) //Aim_Fov
    val aimFovSlider = VisSlider(1F, 360F, 2F, false) //Aim_Fov
    val aimSpeedMinLabel = VisLabel("Aim Speed Min: " + SHOTGUN_AIM_SPEED_MIN.toString() + when(SHOTGUN_AIM_SPEED_MIN.toString().length) {3->"  " 2->"    " else ->"      "}) //Aim_Speed_Min
    val aimSpeedMinSlider = VisSlider(1F, 100F, 1F, false) //Aim_Speed_Min
    val aimSpeedMaxLabel = VisLabel("Aim Speed Max: " + SHOTGUN_AIM_SPEED_MAX.toString() + when(SHOTGUN_AIM_SPEED_MAX.toString().length) {3->"  " 2->"    " else ->"      "}) //Aim_Speed_Max
    val aimSpeedMaxSlider = VisSlider(2F, 100F, 1F, false) //Aim_Speed_Max
    val aimStrictnessLabel = VisLabel("Aim Strictness: " + SHOTGUN_AIM_STRICTNESS.toString()) //Aim_Strictness
    ...
    val perfectAimFovLabel = VisLabel("Perfect Aim Fov: " + SHOTGUN_PERFECT_AIM_FOV.toString() + when(SHOTGUN_PERFECT_AIM_FOV.toString().length) {3->"  " 2->"    " else ->"      "}) //Perfect_Aim_Fov
    val perfectAimFovSlider = VisSlider(0F, 100F, 1F, false) //Perfect_Aim_Fov
    val perfectAimChanceLabel = VisLabel("Perfect Aim Chance: " + SHOTGUN_PERFECT_AIM_CHANCE.toString() + when(SHOTGUN_PERFECT_AIM_CHANCE.toString().length) {3->"  " 2->"    " else ->"      "}) //Perfect_Aim_Chance
    ...
    val aimAssistStrictnessLabel = VisLabel("Aim Assist Strictness: " + SHOTGUN_AIM_ASSIST_STRICTNESS.toString() + when(SHOTGUN_AIM_ASSIST_STRICTNESS.toString().length) {3->"  " 2->"    " else ->"      "}) //Aim_Assist_Strictness
    ...
    init {
        ...
        enablePathAim.changed { _, _ ->
            ...
            SHOTGUN_ENABLE_FLAT_AIM = !SHOTGUN_ENABLE_PATH_AIM
            UIUpdate()
            true
        }
        ...
        aimBoneBox.changed { _, _ ->
            if (aimBoneBox.selected.toString() == "HEAD_BONE") {
                SHOTGUN_AIM_BONE = HEAD_BONE
            }
            else if (aimBoneBox.selected.toString() == "BODY_BONE") {
                SHOTGUN_AIM_BONE = BODY_BONE
            }
        }
        ...
        //val aimFovLabel = VisLabel("Aim Fov: " + SHOTGUN_AIM_FOV.toString() + when(SHOTGUN_AIM_FOV.toString().length) {3->"  " 2->"    " else ->"      "}) //Need alternative for all of these, has to be some kind of setup for it
        ...
        //val aimSpeedMinLabel = VisLabel("Aim Speed Min: " + SHOTGUN_AIM_SPEED_MIN.toString() + when(SHOTGUN_AIM_SPEED_MIN.toString().length) {3->"  " 2->"    " else ->"      "})
        ...
        //val aimSpeedMaxLabel = VisLabel("Aim Speed Max: " + SHOTGUN_AIM_SPEED_MAX.toString() + when(SHOTGUN_AIM_SPEED_MAX.toString().length) {3->"  " 2->"    " else ->"      "})
        ...
        //val aimStrictnessLabel = VisLabel("Aim Strictness: " + SHOTGUN_AIM_STRICTNESS.toString()) //Doesnt need when as it stays 1.0 through 5.0
        ...
        perfectAimCollapsible.setCollapsed(!SHOTGUN_PERFECT_AIM, true)
        ...
        //val perfectAimFovLabel = VisLabel("Perfect Aim Fov: " + SHOTGUN_PERFECT_AIM.toString() + when(SHOTGUN_PERFECT_AIM.toString().length) {3->"  " 2->"    " else ->"      "})
        ...
        //val perfectAimChanceLabel = VisLabel("Perfect Aim Chance: " + SHOTGUN_PERFECT_AIM_CHANCE.toString() + when(SHOTGUN_PERFECT_AIM_CHANCE.toString().length) {3->"  " 2->"    " else ->"      "})
        ...
        if (SHOTGUN_AIM_ASSIST_MODE) aimAssistCheckBox.isChecked
        //val aimAssistTable = VisTable()
        //val aimAssistCollapsible = CollapsibleWidget(aimAssistTable)
        aimAssistCollapsible.isCollapsed = !SHOTGUN_AIM_ASSIST_MODE//setCollapsed(!SHOTGUN_AIM_ASSIST_MODE)
        ...
        //val aimAssistStrictnessLabel = VisLabel("Aim Assist Strictness: " + SHOTGUN_AIM_ASSIST_STRICTNESS.toString() + when(SHOTGUN_AIM_ASSIST_STRICTNESS.toString().length) {3->"  " 2->"    " else ->"      "})
        ...
        aimAssistStrictnessSlider.changed { _, _ ->
            ...
            aimAssistStrictnessLabel.setText("Aim Assist Strictness: " + SHOTGUN_AIM_ASSIST_STRICTNESS.toString() + when(SHOTGUN_AIM_ASSIST_STRICTNESS.toString().length) {3->"  " 2->"    " else ->"      "}) //When is used to not make the sliders jitter when you go from 10 to 9, or 100 to 99, as that character space shifts everything, one character is 2 spaces
        }
