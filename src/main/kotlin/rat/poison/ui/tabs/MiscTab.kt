...
class MiscTab : Tab(false, false) {
    ...
    init {
        ...
        subPaneTable1.addSeparator().width(250F).left().padLeft(5F)
        ...
        //Bottom right pane (fov + bomb timer + spectator list)
        ...
        subPaneTable2.addSeparator().width(250F).left().padLeft(5F)
        ...
        superPaneTable1.addSeparator().width(250F).left().padLeft(5F)
        ...
        superPaneTable1.addSeparator().width(250F).left().padLeft(5F)
        superPaneTable1.add(selfNade).left().padLeft(5F).fillX().row()
