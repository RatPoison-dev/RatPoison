...
import rat.plague.game.offsets.EngineOffsets.pStudioModel
...
import rat.plague.utils.collections.CacheableList
...
internal fun skeletonEsp() {
	RatPlagueOverlay {
		if (!SKELETON_ESP || !ENABLE_ESP) return@RatPlagueOverlay
