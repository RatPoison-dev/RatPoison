...
import rat.plague.game.hooks.constructEntities
import rat.plague.game.netvars.NetVars
import rat.plague.overlay.RatPlagueOverlay
import rat.plague.overlay.RatPlagueOverlay.camera
import rat.plague.overlay.Overlay
import rat.plague.settings.*
import rat.plague.utils.every
import rat.plague.utils.inBackground
import rat.plague.utils.natives.CUser32
import rat.plague.utils.retry
...
object CSGO {
	...
	fun initialize() {
		...
		every(1000) {
			...
			if (Overlay.opened && RatPlagueOverlay.created && (lastWidth != gameWidth || lastHeight != gameHeight))
