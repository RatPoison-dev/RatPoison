...
//Rifles
AK47 = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
AUG = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
FAMAS = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
SG553 = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
GALIL = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
M4A4 = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
M4A1_SILENCER = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
NEGEV = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
M249 = doubleArrayOf(0.0, 1.0, 0.0, 1.0, 6.0, 80.0, 16.0, 1.0, 2.0, 1.0, 5.0, 10.0)
